...
write.table(data, file=glue('1_data/data_master_250813.tsv'), sep='\t', row.names = FALSE)
write.csv(data,   file=glue('1_data/data_master_250813.csv', row.names=FALSE))
write.xlsx(data,  file=glue('1_data/data_master_250813.xlsx'))
